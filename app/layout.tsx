...
export const metadata: Metadata = {
  title: "Ali Haidar | Personal Portfolio",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body className={`${inter.className} dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90 bg-gray-50 text-gray-950 relative pt-28 sm:pt-36`}>
